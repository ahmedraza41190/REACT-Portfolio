                ...
                <div className='contactMainBlock'>
                    <div className='contactIndividualBlock'>
                        ...
                        <div
                            ...
                            data-aos-once="false"
                            data-aos-anchor-placement="top">
                            <a className='myEmail' href="mailto:ragix.aemi@gmail.com">ragix.aemi@gmail.com</a>
                        </div>
                    </div>
                    <div className='contactIndividualBlock'>
                        <div className='arrowDiv'
                        ...
                        <div
                            ...
                            data-aos-once="false"
                            data-aos-anchor-placement="top">
                            <p className='myPhone' >0336-2187809</p>
                        </div>
                    </div>
                    <div className='contactIndividualBlock'>
                        <div className='arrowDiv'
                        ...
                        <div
                            ...
                            data-aos-once="false"
                            data-aos-anchor-placement="top">
                            <p className='myAddress' >Mona Heights Block # 5 Gulshan-e-iqbal Karachi.</p>
                        </div>
                    </div>
                    ...
                    <div className='contactSocialDiv'
                     ...
                     data-aos-once="false"
                     data-aos-anchor-placement="top">
                        <a href='https://www.facebook.com/profile.php?id=100009195927085' rel="noreferrer" target="_blank"><div><FaFacebookF className='contactIcons' /></div></a>
                        <a href='https://www.instagram.com/ahmed_raza41190/?hl=en' rel="noreferrer" target="_blank"><div><FaInstagram className='contactIcons' /></div></a>
                        <a href='https://www.linkedin.com/in/ahmed-raza-fullstack-developer/' rel="noreferrer" target="_blank"><div><FaLinkedinIn className='contactIcons' /></div></a>
                    </div>
                </div>
            </div>
        </div>
