...
/>
      ...
      <div className="navBarDiv">
        <nav className="nav-bar">
          <ul className="nav-ul">
            ...
            <li><link href="https://github.com/ahmedraza41190" target="_blank">PROJECTS</link></li>
      ...
      <main>
        ...
        <p className="about_para">
          Hi, I am a Full-Stack Web Developer born and rased in <link
            href="https://en.wikipedia.org/wiki/Karachi">Karachi, Pakistan.</link>And currently I am a student of BSCS in "Orasoft Institute".
        ...
        <ul className="contact_ul">
          ...
          <li><link href="https://www.instagram.com/ahmed_raza41190/?hl=en" target="_blank">Instagram<i><svg
          ...
          <li><link href="https://youtu.be/OuFIF_gCuBA" target="_blank">YouTube<i><svg
